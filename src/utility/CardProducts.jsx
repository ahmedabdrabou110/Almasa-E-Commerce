    ...
    <div className="col-sm-6 col-md-4 col-lg-3 col-sm-12">  
        <Card style={{ margin:"10px" }}>
                ...
                <Link to={`/products/${product?.productId}`} style={{ textDecoration: 'none', cursor:"pointer" }}>
                    <Card.Img style={{ height: "400px", width: "100%" }} src={product?.image} />
                </Link>
            ...
            <Card.Body>
                ...
                <Button variant="secondary" style={{width:"100%",display:"flex",justifyContent:"space-between"}} onClick={handleCart}>
                    <span>أضف للسلة</span>
